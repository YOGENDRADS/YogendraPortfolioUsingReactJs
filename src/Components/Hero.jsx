        ...
        <div className="w-full lg:w-1/2">
          <div className="flex flex-col items-center lg:items-start">
            ...
            >
              ...
              <br /> <br /> <br />
              <a
            className=" text-2xl  m-8   px-3  py-2 bg-indigo-950  rounded-full shadow-lg"
            href="https://drive.google.com/file/d/1LCGWM90JdcfEjk2jKv403qYt6etnMDiF/view" target="_blank">
