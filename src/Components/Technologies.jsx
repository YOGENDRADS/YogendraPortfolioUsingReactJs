...
import { SiAngular, SiEclipseadoptium, SiEclipseche, SiGit, SiGithub, SiMongodb, SiMysql, SiOracle, SiVisualstudiocode } from "react-icons/si";
    ...
    <div className="border-b border-neutral-800 pb-24">
      ...
      >
        ...
        <motion.div
          ...
          className="rounded-2xl border-4 border-neutral-800 p-4"
        >
          <FaAngular className="text-7xl text-yellow-200" />
        </motion.div>
